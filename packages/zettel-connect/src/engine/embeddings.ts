...
const CACHE_REL = ".obsidian/plugins/zettel-connect/cache/embeddings.json";
...
export class EmbeddingEngine {
  ...
  async flushCache(): Promise<void> {
    ...
    try {
      ...
      console.error("[zettel-connect] cache flush failed:", err);
    }
  }
  ...
  async clearCache(): Promise<void> {
    ...
    try {
      ...
      console.warn("[zettel-connect] cache clear failed:", err);
    }
  }
  ...
  async embed(text: string): Promise<number[] | null> {
    ...
    try {
      ...
      this.lastError = msg;
      console.warn("[zettel-connect] embed failed:", msg);
      return null;
    }
  }
